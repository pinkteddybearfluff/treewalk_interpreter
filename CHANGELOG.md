...
- Better support/error messages for SyntaxError and SemanticError.
...
### Fixed
- Stray returns, break and continue (break and continue outside of loops and return statements outside of function declarations) now give Syntax/Semantic errors.
